 ...
 *
 * @package    404.php @ 2021-05-13T11:19:03.179Z
...
<head>
    <meta charset="UTF-8">
    <title>PHPXI::404 Page Not Found</title>
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <link rel="stylesheet" href="<?php echo public_url("assets/css/normalize.min.css"); ?>" />
  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-md-6 align-self-center">
        ...
        <a class="btn purple" href="<?php echo public_url(); ?>">HOME</a>
      </div>
    </div>
  </div>
</main>
